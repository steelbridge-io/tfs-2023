...
<?php echo '<body class="scroll landing archivetemplate sections-template stream-report travel-destination outfitters-dept private-waters schools-template fish-camp-template default-template non-banner-loading&nbsp;'.implode('&nbsp;', get_body_class()).'">'.PHP_EOL; ?>
                             ...
                             <header id="header" <?php if ( is_admin_bar_showing() ){ echo 'style="margin-top:32px;"'; } ?> class="alt">
                               ...
                               <div id="page-wrapper-hero-template">
                                 <header id="header" <?php if ( is_admin_bar_showing() ){ echo 'style="margin-top:32px;"'; } ?> class="alt">
                                   ...
                                   <!-- ==== Sections template hero image ==== -->
	                                 <?php elseif (is_page_template('page-templates/sections-template.php')): ?>

                                   <div id="page-wrapper-sections-template" class="x-wide">
                                     <header id="header" <?php  if ( is_admin_bar_showing() ){ echo 'style="margin-top:32px;"'; } ?> class="alt">
