...
if($form_id == 59) {
	include_once(get_template_directory() . '/questionnaire-config/table-entries-per-destination/master-questionnaire-table.php');
}

if($form_id == 329) {
	include_once( get_template_directory() . '/questionnaire-config/table-entries-per-destination/alaska-rainbow-adventures-table.php' );
}
...
if( $form_id == 329) {
require_once get_template_directory() . '/questionnaire-config/alaska-rainbow-adventures-ak-questionnaire.php';
}
