...
// Name
    ...
    $show_meta_field = get_post_meta($post->ID, '_gda_show_meta_field_arrival_airport', true);
    ...
    // Check if the checkbox is checked
    $show_meta_field = get_post_meta($post->ID, '_gda_show_meta_field_arrival_airline', true);
    ...
    // Check if the checkbox is checked
    $show_meta_field = get_post_meta($post->ID, '_gda_show_meta_field_other_arrival_airline', true);
    ...
    // Check if the checkbox is checked
    $show_meta_field = get_post_meta($post->ID, '_gda_show_meta_field_flight_arrival_date', true);
    ...
    // Check if the checkbox is checked
    $show_meta_field = get_post_meta($post->ID, '_gda_show_meta_field_flight_arrival_number', true);
    ...
    // Check if the checkbox is checked
    $show_meta_field = get_post_meta($post->ID, '_gda_show_meta_field_flight_arrival_time', true);
    ...
    // Check if the checkbox is checked
    $show_meta_field = get_post_meta($post->ID, '_gda_show_meta_field_flight_departure_date', true);
    ...
    // Check if the checkbox is checked
    $show_meta_field = get_post_meta($post->ID, '_gda_show_meta_field_flight_departure_number', true);
    ...
    // Check if the checkbox is checked
    $show_meta_field = get_post_meta($post->ID, '_gda_show_meta_field_flight_departure_time', true);
