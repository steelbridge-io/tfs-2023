<?php
/**
 * Template Name: Taylor River Lodge
 ...
 */
$form_id                   = '55'; // Your Gravity Form ID
$search_criteria['status'] = 'active';
$sorting                   = array(
    'key'        => '1.6',
    'direction'  => 'ASC',
...
foreach ( $entries as $entry ) {
   ...
   /* if (rgar($entry, '101') != '') {
	...
	// Body Weight
	if (rgar($entry, '287') != '') {
		echo '<div class="col-12 form-entry"><b>Body weight (pounds):</b>'
		     . rgar( $entry, '287' ) . '</div>';
	}

	// Height
	if (rgar($entry, '288') != '') {
		echo '<div class="col-12 form-entry"><b>Height (feet & inches):</b>'
		     . rgar( $entry, '288' ) . '</div>';
	}
