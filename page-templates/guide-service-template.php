...
<?php if ( ! empty( $guidesvc_temp_video ) || ! empty( $guidesvc_temp_video_poster ) ) : ?>
    ...
    <section id="banner" class="guidesvc-temp-hero-overlay">
        ...
        <div id="guidesvc-temp-hero-video" class="inner">
			<?php
			if ( ! empty( $guide_logo ) ) { ?>
                <img src="<?php echo $guide_logo; ?>"
...
if ( empty( $guidesvc_temp_video ) || empty( $guidesvc_temp_video_poster ) ) : ?>

    <!-- Banner -->
    <section id="banner">
        <div class="inner">
			<?php $guide_logo = get_post_meta( get_the_ID(),
				'guideservice-logo',
				TRUE );
			if ( ! empty( $guide_logo ) ) { ?>
                <img src="<?php echo $guide_logo; ?>"
			...
			<?php } ?>
            <h2><?php the_title(); ?></h2>
			<?php $guideservice_description = get_post_meta( get_the_ID(),
				'guideservice-description',
				TRUE );
			if ( ! empty( $guideservice_description ) ) { ?>
                <p class="template-description"><?php echo $guideservice_description ?></p>
			<?php } ?>
						...
						<?php if ( ! empty( $feature_gs1_inclusions_textarea ) ) : ?>
                            <div class="panel-travel privatewaters1">
                                <div class="panel-heading accordion-toggle collapsed"
                                    ...
                                    <h4 class="panel-title travel">Inclusions&nbsp;<span
						...
						<?php if ( ! empty( $feature_gs1_packagedeal_textarea ) ) : ?>
                            <div class="panel-travel privatewaters1">
                                <div class="panel-heading accordion-toggle collapsed"
                                    ...
                                    <h4 class="panel-title travel">Package Deal&nbsp;<span
                                                class="arrow-down"></span></h4>
                                </div>
                    ...
                    <div class="panel-group" id="accordion-seasons-readmore">
                        <div class="panel-travel guidewaters_fishing4">
							...
							if ( ! empty( $feature_gs2_seasons_readmore ) ) :?>
                                ...
                                <div class="panel-heading accordion-toggle collapsed"
                                     data-toggle="collapse"
                                     data-parent="#accordion-seasons-readmore"
                    ...
                    <div class="panel-group"
                        ...
                        <div class="panel-travel guidewaters_fishing4">
							...
							if ( ! empty( $feature_gs3_fishing_readmore ) ) :?>
                                ...
                                <div class="panel-heading accordion-toggle collapsed"
                                     data-toggle="collapse"
                                     data-parent="#accordion-fishing-guide-readmore"
...
<?php } ?>
    ...
    <div class="additional-img modal fade guide-modal" tabindex="-1"
        ...
        <div class="additional-img modal-dialog" role="document">
            ...
            <div id="guide-carousel" class="carousel slide"
                ...
                <!-- Controls -->
                <a class="left carousel-control" href="#guide-carousel"
                   role="button" data-slide="prev">
                    <span class="glyphicon glyphicon-chevron-left"
                          aria-hidden="true"></span>
                    <span class="sr-only">Previous</span>
                </a>
                <a class="right carousel-control" href="#guide-carousel"
