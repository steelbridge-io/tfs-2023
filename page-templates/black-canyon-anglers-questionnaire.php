<?php
/**
 * Template Name: Black Canyon Anglers
 ...
 */
$form_id                   = '62'; // Your Gravity Form ID
$search_criteria['status'] = 'active';
$sorting                   = array(
    'key'        => '1.6',
    'direction'  => 'ASC',
...
foreach ( $entries as $entry ) {
   ...
   /* if (rgar($entry, '101') != '') {
	...
	if (rgar($entry, '291') != '') {
		echo '<div class="col-12 form-entry"><b>Would you like to have an ice cooler filled with block ice:  $125.00. If not all drinks are cooled in the river:</b>'
		     . rgar( $entry, '291' ) . '</div>';
	}
	...
	if (rgar($entry, '292') != '') {
		echo '<div class="col-12 form-entry"><b>Guests wishing to avoid carrying personal gear to the river on their back may prearrange to have their gear taken in for an additional fee. Would you like to have your personal gear packed to the River?:</b>'
		     . rgar( $entry, '292' ) . '</div>';
	}
